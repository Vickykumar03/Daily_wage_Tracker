...
https://daily-wage-tracker-1.onrender.com
...
- **MongoDB** → Local: https://www.mongodb.com/try/download/community or Free cloud: https://www.mongodb.com/atlas/database

### 2. Clone & Install
```bash
git clone https://github.com/Vickykumar03/Daily_Wage_Tracker.git
...
**Vicky Kumar** — [@Vickykumar03](https://github.com/Vickykumar03)

---

> 💡 *Built to empower daily wage workers with a simple tool to record their earnings and prove their income when it matters most.* ..just add this link..https://daily-wage-tracker-1.onrender.com 
